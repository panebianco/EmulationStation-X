    ...
    , mMenu(window, title)
{
    ...
    mMenu.addButton(tr("BACK"), tr("go back"), [this] { delete this; });
...
void GuiScreensaverOptions::addEditableTextComponent(ComponentListRow row, const std::string label,
